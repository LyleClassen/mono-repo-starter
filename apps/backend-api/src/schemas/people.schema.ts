...
export type CreatePerson = Static<typeof CreatePersonSchema>;
export type UpdatePerson = Static<typeof UpdatePersonSchema>;
export type ListPeopleQuery = Static<typeof ListPeopleQuerySchema>;
export type PersonIdParam = Static<typeof PersonIdParamSchema>;
export type PeopleListResponse = Static<typeof PeopleListResponseSchema>;
